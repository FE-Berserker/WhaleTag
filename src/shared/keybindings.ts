import type { ViewMode } from './whale-meta';
 ...
 * keys can map to the same action (e.g. both `Enter` and `ArrowRight` →
 * `open`) and so there are never two actions fighting over one key.
 *
